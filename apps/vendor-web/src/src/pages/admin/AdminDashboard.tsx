...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    api.adminMetrics().then(setMetrics).catch(() => {});
  }, []);
  return (
    <AdminLayout>
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-foreground">{metrics?.pendingPayments ?? 12}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-destructive">{metrics?.openDisputes ?? 3}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-warning">{metrics?.vendorApprovals ?? 8}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-success">{metrics?.activeJobs ?? 145}</h3>
                </div>
