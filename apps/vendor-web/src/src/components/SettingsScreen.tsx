            ...
            <div className="grid grid-cols-2 gap-2">
              {LANGUAGES.map((l) => (
                <button key={l.code} onClick={() => setLang(l.code as Lang)}
                  className={`flex items-center justify-between p-3 rounded-xl border transition-colors ${lang === l.code ? "border-primary bg-primary/5" : "border-transparent hover:bg-muted"}`}>
            ...
            <div className="grid grid-cols-2 gap-2">
              {COUNTRIES.map((c) => (
                <button key={c.code} onClick={() => setCountry(c.code)}
                  className={`flex items-center gap-3 p-3 rounded-xl border transition-colors ${country === c.code ? "border-primary bg-primary/5" : "border-transparent hover:bg-muted"}`}>
