    ...
    <VendorLayout>
      <VendorHeader shopName={shopName} online={online} onToggle={toggle}>
        <div className="grid grid-cols-2 gap-3 mt-5">
          <div className="bg-white/15 backdrop-blur rounded-[24px] p-4">
      ...
      <PullToRefresh onRefresh={load}>
        <div className="px-4 -mt-6 space-y-6 min-h-[60vh] pb-6">
          {active && (
            <div>
              <SectionHeader title="Current assignment" />
              <Link href={`/vendor/order/${active.job_id}`}>
                <Card className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200/50 dark:border-slate-800/50 shadow-sm rounded-[24px] relative overflow-hidden hover:shadow-md transition-shadow">
                  ...
                  <CardContent className="p-5">
                    ...
                    <h3 className="font-bold text-lg mb-1">
                      {active.short_id ? <span className="text-primary font-mono text-sm mr-2">#{active.short_id}</span> : null}
                      {active.description?.slice(0, 40) || active.category_id}
                    </h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link href="/vendor/jobs" className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200/50 dark:border-slate-800/50 rounded-[24px] shadow-sm p-4 flex flex-col items-center gap-3 hover:shadow-md transition-shadow">
              ...
              <Link href="/vendor/profile" className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200/50 dark:border-slate-800/50 rounded-[24px] shadow-sm p-4 flex flex-col items-center gap-3 hover:shadow-md transition-shadow">
                <div className="w-12 h-12 rounded-full bg-warning/10 flex items-center justify-center text-warning"><Star className="w-6 h-6" /></div>
          ...
          <Link href="/vendor/jobs">
            <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200/50 dark:border-slate-800/50 rounded-[24px] shadow-sm p-5 flex items-center justify-between hover:shadow-md transition-shadow">
              <div>
