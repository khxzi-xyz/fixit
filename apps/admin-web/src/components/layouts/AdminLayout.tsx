...
import { LayoutDashboard, CreditCard, Users, ShieldAlert, List, Settings, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground flex md:flex-row flex-col">
      ...
      <header className="md:hidden flex items-center justify-between p-4 bg-card border-b border-border sticky top-0 z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg tracking-tight">FixIt Admin</span>
        </div>
      </header>
      ...
      <aside className="hidden md:flex flex-col w-64 bg-card border-r border-border h-screen sticky top-0">
        <div className="p-6 flex items-center gap-3 border-b border-border">
          ...
          <span className="font-bold text-xl tracking-tight">FixIt Admin</span>
        </div>
        ...
        <div className="p-4 border-t border-border">
          <Link href="/" className="flex items-center gap-3 px-3 py-3 rounded-lg text-destructive hover:bg-destructive/10 transition-colors">
